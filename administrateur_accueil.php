...
<head>
	...
	<link rel="stylesheet" type="text/css" href="enpage2.css">
...
<body>
	<nav>
		<ul>
			<li><a href="administrateur_Accueil.php">Accueil</a></li>
			<li><a href="administrateur_inscription.html">Inscription de coachs</a></li>
			<li><a href="administrateur_suppression.html">Suppression de coachs</a></li>
			<li><a href="administrateur_Listes.php">Listes de coachs</a></li>			
			<li><a href="administrateur_votrecompte.html">Votre compte</a></li>
			<li><a href="administrateur_Accueil.php"><img id="logo" src="Logo_Projet.png" width="100px" height="70px"></a></li>
