...
<body>
	...
	<div class="container1">
		...
		<img src="cardio.jpg" width="100%" height="350px"></br></br>
		<p><strong>Cardio-Training </strong>rassemble des activités de fitness sollicitant le muscle cardiaque afin de l'entraîner à l'effort et ainsi de renforcer les systèmes cardio-vasculaire et cardio-respiratoire(@sport-passion)
		</p></br></br>
		<div class="container4"></br>
			<div class="voir-coach">
				<a href="Coach_cardio.php?data=<?=$pseudo?>" class="voir-coach"> <strong>Voir coach : </strong></a></br></br>
				<img src="coach_training.jpg" width="80%" height="350px"></br>
				Coach : M. Camille</br>
				Mail : <i>xxxxxxx@omneseducations.Fr</i></br>
				Texto : <i>06 55 19 xx xx</i></br></br>
			</div></br></br>
				<HR></br>
		</div></br></br>
	</div></div>
	<div class="container1">
		...
		<a href="CV_training.xml">Lien CV</a>
	</div>
	<footer>
