...
<body>
	...
	<div class="container1">
		<div class="thead-accueil">
			Tout savoir sur le plongeon avec OMNES : <HR></br>
		</div>
		<div class="container1">
			<img src="presentation_plongeon.jpg" width="90%" height="350px"></br></br>
	...
	<div class="container1">
		<div class="thead-accueil">
			Planning pour les seances de plongeon avec coach M. Fish: <HR>
		</div>
		<div class="">
		<?php
			function build_calendar($month, $year) {
			    ...
			    $calendar .= "<center><h1><font color='grey'>Agenda pour $mois $year pour le Plongeon</font></h1>";
			    ...
			    $calendar.= "<a class='btn btn-xs btn-primary' href='?month=".date('m', mktime(0, 0, 0, $month+1, 1, $year))."&year=".date('Y', mktime(0, 0, 0, $month+1, 1, $year))."'>Mois suivant</a></center><br>";
			     ...
			     while ($currentDay <= $numberDays) {
			         ...
			         elseif($date<date('Y-m-d')){
			             ...
			             $calendar.="<td class='$today'><h2><center><font color='grey'>$currentDay</font></center></h2> <a href='reservation_plongeon.php?date=".$date."' class='btn btn-success btn-xs'>Creneau disponible</a>";
			         } 
			          $calendar .="</td>";
			          $currentDay++;
			          $dayOfWeek++;
	...
	<div class="container1">
		...
		$sql = "SELECT * FROM Messagerie WHERE (Coachs ='Fish') AND(Clients = 'arthur') ORDER BY ID DESC" ;
		$taille = 0;
