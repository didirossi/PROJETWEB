...
<body>
	...
	<div class="container1">
		...
		<div class="container1">
			...
			<img src="fitness.Webp" width="100%" height="350px"></br></br>
			<p>Sous le terme fitness sont regroupées une pluralité d'activités qu'elles soient individuelles, comme les exercices de cardio, de musculation, d'étirements, ou collectives, à l'instar de la zumba, du step, des abdos-fessiers, du body combat ou d'autres déclinaisons visant l'amélioration de la condition physique. (@LeFigaro)
			</p></br></br>
			<div class="container4"></br>
			<div class="voir-coach">
				<a href="Coach_fitness.php?data=<?=$pseudo?>" class="voir-coach"> <strong>Voir coach : </strong></a></br></br>
				<img src="coach_Fitness.jpg" width="80%" height="350px"></br>
				Coach : M.Martin</br>
				Mail : <i>xxxxxxx@omneseducations.Fr</i></br>
				Texto : <i>06 12 63 xx xx</i></br></br>
			</div></br></br>
				<HR></br>
		</div></br></br>
