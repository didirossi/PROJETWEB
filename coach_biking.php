...
<body>
	...
	<div class="container1">
		<?php
			function build_calendar($month, $year) {
			    ...
			    $calendar .= "<center><h1><font color='grey'>Agenda pour $mois $year avec M. Thierry</font></h1>";
			    ...
			    $calendar.= "<a class='btn btn-xs btn-primary' href='?month=".date('m', mktime(0, 0, 0, $month+1, 1, $year))."&year=".date('Y', mktime(0, 0, 0, $month+1, 1, $year))."'>Mois suivant</a></center><br>";
			     ...
			     while ($currentDay <= $numberDays) {
			         ...
			         elseif($date<date('Y-m-d')){
			             ...
			             $calendar.="<td class='$today'><h2><center><font color='grey'>$currentDay</font></center></h2> <a href='reservation_biking.php?date=".$date."' class='btn btn-success btn-xs'>Creneau disponible</a>";
			         } 
			          $calendar .="</td>";
			          $currentDay++;
			          $dayOfWeek++;
	...
	<div class="container1">
		<div class="thead-accueil">
		    ...
		    <form action="Etat_biking.php" method="get">
		...
		$sql = "SELECT * FROM Messagerie WHERE (Coachs ='Thierry') AND(Clients = 'arthur') ORDER BY ID DESC" ;
		$taille = 0;
	...
	<div class="container1">
		...
		<a href="CV_biking.xml">Lien CV</a>
	</div>
