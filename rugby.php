...
L'essentiel du jeu consiste à tenter de faire progresser le ballon vers l'avant, c'est-à-dire l'en-but adverse, pour marquer des points grâce à un essai, un drop, ou une pénalité due à une faute adverse ; ceci, tout en tentant d'empêcher l'équipe adverse d'en faire autant. Le cours du jeu est segmenté en différents types de phases :
	...
	<div class="container1">
		<div class="thead-accueil">
			Planning pour les seances de Rugby avec coach M. Guy Noves: <HR>
		</div>
		<div class="">
		<?php
			function build_calendar($month, $year) {
			    ...
			    $calendar .= "<center><h1><font color='grey'>Agenda pour $mois $year pour le Rugby</font></h1>";
			    ...
			    $calendar.= "<a class='btn btn-xs btn-primary' href='?month=".date('m', mktime(0, 0, 0, $month+1, 1, $year))."&year=".date('Y', mktime(0, 0, 0, $month+1, 1, $year))."'>Mois suivant</a></center><br>";
			     ...
			     while ($currentDay <= $numberDays) {
			         ...
			         elseif(($dayOfWeek == 0) OR ($dayOfWeek == 1)){
			         ...
			         elseif($date<date('Y-m-d')){
			             ...
			             $calendar.="<td class='$today'><h2><center><font color='grey'>$currentDay</font></center></h2> <a href='reservation_rugby.php?date=".$date."' class='btn btn-success btn-xs'>Creneau disponible</a>";
			         } 
			          $calendar .="</td>";
			          $currentDay++;
			          $dayOfWeek++;
	...
	<div class="container1">
		...
		$sql = "SELECT * FROM Messagerie WHERE (Coachs ='Noves') AND(Clients = 'arthur') ORDER BY ID DESC" ;
		$taille = 0;
	...
	<nav>
		<ul>
			...
			<li><a href="#">Tout Parcourir</a></li>
					<li><a href="Activite.html">Activites Sportives</a></li>
					<li><a href="Sport.html">Sports de competition</a></li>
					<li><a href="Salle.html">Salle de sport</a></li>
			
			<li><a href="Recherche.Html">Recherche</a></li>
			<li><a href="RendezVous.html">Rendez-Vous</a></li>
			<li><a href="VotreCompte.Html">Votre compte</a></li>
			<li><a href="Accueil.html"><img id="logo" src="Logo_Projet.png" width="100px" height="80px"></a></li>
		</ul>
	</nav>
	</br></br>

	<div class="font-sport">
		</br></br>
		<div class="container-sport">
			<div class="nav-sport">
				<div class="bloc-sport">
					<div id="title-sport">
						<h4>Planning du coach : </h4>
					</div><HR>
					<div id="liste-sport">
					</div>
				</div>
			...
			<div class="section-sport">
				<div class="bloc-sport">
					<div id="title-sport">
						<h5>Coach Sportif : M. Rolland</h5>
					</div><HR>
					<div id="total-sport">
						Salle : 349 - E2</br>
						<img src="coach_rugby.jpg" width="350px" height="200px">
						</br>
						<button id="payer-sport">Prendre un RDV</button>
						<button id="payer-sport">Communiquer avec le coach</button>
						<button id="payer-sport">Telechargez son CV</button>
					</div>
